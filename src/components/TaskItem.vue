...
<template>
  <div class="task-item bg-gray-800 text-white p-4 rounded-lg shadow-lg flex items-center space-x-4 m-5" :class="{ 'opacity-50': task.getStatus() === 'Complete' }">
    <div class="flex flex-1">
      <button @click="handleToggle" class="mr-5">
      ...
      <div>
        <h2 class="text-xl font-semibold mr-3 text-left" :class="{ 'line-through': task.getStatus() === 'Complete' }">{{ task.getTitle() }}</h2>
        <div class="flex">
